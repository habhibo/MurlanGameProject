...
{
    public class SinglePlayerGameModel : PageModel
    {
        private readonly Business _business;
        private readonly ILogger<SinglePlayerGameModel> _logger;


        public SinglePlayerGameModel(Business business, ILogger<SinglePlayerGameModel> logger)
        {
            _business = business;
            _logger = logger;
        }
